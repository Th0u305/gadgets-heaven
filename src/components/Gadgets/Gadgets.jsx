...
const Gadgets = () => {
  ...
  const [errorData2] = useState(true);
  ...
  return (
    <div className="flex flex-col 2xl:flex-row 2xl:items-start justify-center items-center gap-8">
      <div
        className="grid grid-rows-2 grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-rows-1 2xl:grid-cols-1 
      ...
      {errorData2 && (
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3 2xl:w-[90%]">
